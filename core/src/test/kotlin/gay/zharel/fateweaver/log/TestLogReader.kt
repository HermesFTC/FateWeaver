...
class TestLogReader {
    ...
    fun testLogReaderBasicReadWrite() {
        ...
        val writer = FateLogWriter(outputStream)
        ...
        val reader = FateLogReader(inputStream)
        ...
        assertTrue(entries[0] is FateLogEntry.Schema)
        assertTrue(entries[1] is FateLogEntry.Schema)

        val schema1 = entries[0] as FateLogEntry.Schema
        val schema2 = entries[1] as FateLogEntry.Schema
        ...
        val message1 = entries[2] as FateLogEntry.Message<*>
        val message2 = entries[3] as FateLogEntry.Message<*>
        val message3 = entries[4] as FateLogEntry.Message<*>
        val message4 = entries[5] as FateLogEntry.Message<*>
    ...
    fun testLogReaderWithAllPrimitiveTypes() {
        ...
        val messageEntries = allEntries.filterIsInstance<FateLogEntry.Message<*>>()
    ...
    fun testLogReaderWithEnums() {
        ...
        val messageEntries = reader.readAll().filterIsInstance<FateLogEntry.Message<*>>()
        reader.close()
    ...
    fun testLogReaderReadMessagesForChannel() {
        ...
        val reader2 = FateLogReader(inputStream2)
    ...
    fun testLogReaderIterator() {
        ...
        val entries = mutableListOf<FateLogEntry>()
    ...
    fun testLogReaderFileOperations(@TempDir tempDir: Path) {
        ...
        val message1 = entries1[1] as FateLogEntry.Message<*>
        val message2 = entries2[1] as FateLogEntry.Message<*>
